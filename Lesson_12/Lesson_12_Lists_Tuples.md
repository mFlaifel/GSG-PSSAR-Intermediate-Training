...
- Loop over lists with values, indexes, and `enumerate()`
- Use list comprehensions for simple transformations and filters
- Explain when to use tuples instead of lists
- Avoid common list bugs such as accidental shared references
...
| Time | Topic |
|------|-------|
| 0:00-0:10 | Review: lists from earlier lessons |
| 0:10-0:35 | Indexing, slicing, and updating lists |
| 0:35-1:00 | List methods and common patterns |
| 1:00-1:20 | Sorting, copying, and nested lists |
| 1:20-1:40 | Tuples and unpacking |
| 1:40-2:00 | Mini-project and exercises |

---

## Part 1 - What Is a List? (10 min)
...
- Commonly used for collections of similar items

---

## Part 2 - Indexing, Slicing, and Updating (25 min)
...
## Part 3 - List Methods and Patterns (25 min)
...
Use `.insert()` when you need a specific position.
...
### 3.3 Searching and Checking Membership
...
Only use `.index()` when you know the item exists, or check with `in` first.

---

### 3.4 Accumulator Pattern with Lists
...
The same logic as a comprehension:
...
### 6.2 When to Use Lists vs Tuples
...
```python
shopping_list = ["bread", "milk", "eggs"]  # list: changes often
coordinates = (31.5, 34.4)                 # tuple: fixed pair
```

---

## Mini-Project - Task Manager (20 min)
...
Challenge: store each task as a dictionary with `title` and `done`.
...
Previous lesson -> **Lesson 11: Functions II - Scope & Advanced Concepts***
