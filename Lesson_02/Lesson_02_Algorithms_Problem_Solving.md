...
Operations
    ...
    |___/      ________/
    | _________                              O(log n)
    |__________________________________________→ n (input size)
```
...
- **Visualgo.net** — visual animations of sorting, searching, and graph algorithms
- **LeetCode Easy problems** — practice translating pseudocode to real code
...
*Next: Lesson 03 — Thinking Like a Programmer*
